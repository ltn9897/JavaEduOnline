                        ...
                        <div  className="row">
                            ...
                            <div  className="col-lg-12 col-md-7">
                                <div  className="vew120 frc123">
                                    <div  className="atlink">These Terms of Use <strong>("Terms")</strong> were last updated on August 1, 2020.</div>
                                ...
                                <div  className="vew120 mt-35 mb-30">			
                                    ...
                                    <ul  className="ntt125 mtl145">
                                        <li><a href="#"  className="term_link14">Accounts</a></li>								
                                        <li><a href="#"  className="term_link14">Course Enrollment and Lifetime Access</a></li>																
                                        <li><a href="#"  className="term_link14">Payments, Credits, and Refunds</a></li>																
                                        <li><a href="#"  className="term_link14">Content and Behavior Rules</a></li>																
                                        <li><a href="#"  className="term_link14">Cursus’s Rights to Content You Post</a></li>																
                                        <li><a href="#"  className="term_link14">Cursus’s Rights</a></li>																
                                        <li><a href="#"  className="term_link14">How to Contact Us</a></li>																
                                    </ul>
                                </div>
                                <div  className="vew120 mt-35 mb-30">			
                                    <h4>1. Accounts</h4>
                                    <p>Morbi lectus nunc, lacinia ut consequat a, semper vel erat. Duis ut lacus nec dui sodales mattis. Mauris tellus dolor, pulvinar sit amet pretium a, malesuada sed tellus. Aliquam ultrices elit neque, quis lacinia ex porttitor non. Donec ac iaculis turpis. Nulla lacinia enim quis orci aliquam, non cursus urna pellentesque.  className aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Phasellus in mi a nisi auctor interdum. Vivamus faucibus magna sed elit interdum consequat. Vestibulum eu tortor vel ante feugiat faucibus quis et urna. Quisque interdum ac enim eu tempus. Fusce viverra, lectus egestas tincidunt cursus, tortor sapien convallis metus, vitae auctor risus metus vel nisi. Aenean dapibus bibendum mauris ut iaculis.</p>
                                </div>
                                <div  className="vew120 mt-35 mb-30">			
